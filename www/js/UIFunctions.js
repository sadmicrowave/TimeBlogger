$(document).ready(function(){
    function clearUIActions(){
        ...
        $('li a.pad').toggleClass('pad').attr('href', '#detailView').find('.delete-icon.activated').toggleClass('activated');
        ...
        if( $(this).hasClass('project') ){
            ...
            if( $detailView.length == 0 ){
                ...
                var projId = $('#detailView').attr('projid'),
                    ...
                    detail_ul = "<ul id='task_detail_ul' class='rounded'><li><input type='text' name='taskname' placeholder='Task Name' id='taskname_input' autocapitalize='on' autocorrect='on' autocomplete='off'></li><li><textarea name='taskdetails' placeholder='Enter a Description of Your Task' rows='3' cols='2' id='taskdetails_input' autocapitalize='on' autocorrect='on' autocomplete='on'></textarea></li></ul>",
    ...
    $(document.body).on(clickEvent, 'a.pad .all-sub .outer-delete-icon', function(){
    //set animations for UI delete icon click event
        ...
        $('.delete-icon', this).toggleClass('activated')
